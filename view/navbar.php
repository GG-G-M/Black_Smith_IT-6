...
<nav class="sidebar d-flex flex-column">
    ...
    <a href="audit.php" class="nav-link" style="color:whitesmoke;"><i class="bi bi-journals"></i><br>Audit</a>
    <a href="admin.php" class="nav-link" style="color:whitesmoke;"><i class="bi bi-person-fill-gear"></i><br>Admin<br>Manage</a>
